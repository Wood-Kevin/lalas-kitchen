...
Still in progress at the time of this entry: the local build itself, with both fixes applied, had not yet completed successfully — see the next entry (or `DEFERRED_COMPLEXITY.md` if it's still open) for the outcome.
